...
{
public:
	struct FVector2D                              ImageSize;                                         // 0x0000(0x0008)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMargin                                Margin;                                            // 0x0008(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
DUMPER7_ASSERTS_FSoftSlateBrush;
...
public:
	...
	struct FSoftSlateBrush                        GamepadBrushes[0x3];                               // 0x0070(0x0070)(Edit, NativeAccessSpecifierPublic)
	struct FSoftSlateBrush                        TouchBrush;                                        // 0x01C0(0x0070)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FCommonInputKeyDisplayData             Value;                                             // 0x0018(0x0230)(Edit, NativeAccessSpecifierPublic)
};
