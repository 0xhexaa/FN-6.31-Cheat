...
public:
	...
	struct FLinearColor                           DefaultFontColor;                                  // 0x01E0(0x0010)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           InvertedFontColor;                                 // 0x01F0(0x0010)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           DefaultDullFontColor;                              // 0x0200(0x0010)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FMargin                                ChatEntryPadding;                                  // 0x1290(0x0010)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FMargin                                FriendActionPadding;                               // 0x1330(0x0010)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                FriendActionHeaderPadding;                         // 0x1340(0x0010)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                FriendActionStatusMargin;                          // 0x1350(0x0010)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FTextBlockStyle                        MarkupTextStyle;                                   // 0x0278(0x01E0)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            MarkupBackground;                                  // 0x0458(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateColor                            ButtonColor;                                       // 0x04E0(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FSlateColor                            ButtonHoverColor;                                  // 0x0508(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FSlateColor                            TipColor;                                          // 0x0530(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            SeperatorBrush;                                    // 0x0558(0x0088)(Edit, NativeAccessSpecifierPublic)
	float                                         SeperatorThickness;                                // 0x05E0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMargin                                MarkupPadding;                                     // 0x05E4(0x0010)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                ButtonPadding;                                     // 0x05F4(0x0010)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FChatMarkupStyle                       ChatMarkupStyle;                                   // 0x6080(0x0608)(Edit, NativeAccessSpecifierPublic)
	struct FSocialSoundSchema                     SoundSchema;                                       // 0x6688(0x0048)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
