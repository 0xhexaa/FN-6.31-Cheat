...
public:
	...
	struct FLinearColor                           ColorAndOpacity;                                   // 0x0050(0x0010)(Edit, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
