...
public:
	...
	struct FVector                                InertiaTensorScale;                                // 0x01C4(0x000C)(Edit, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FNavAvoidanceMask                      AvoidanceGroup;                                    // 0x0230(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNavAvoidanceMask                      GroupsToAvoid;                                     // 0x0234(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNavAvoidanceMask                      GroupsToIgnore;                                    // 0x0238(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	...
	struct FVector                                PendingLaunchVelocity;                             // 0x0240(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FReplicatedVehicleState                ReplicatedState;                                   // 0x024C(0x0014)(Net, Transient, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
// 0x0618 (0x0980 - 0x0368)
class UVehicleAnimInstance final : public UAnimInstance
{
public:
	uint8                                         Pad_368[0x608];                                    // 0x0368(0x0608)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	float                                         AckermannAccuracy;                                 // 0x0384(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
