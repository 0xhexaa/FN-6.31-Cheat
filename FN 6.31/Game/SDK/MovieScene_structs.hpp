...
public:
	...
	TArray<struct FFrameNumber>                   Times;                                             // 0x0010(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<TSoftObjectPtr<class UObject>>         Values;                                            // 0x0020(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UObject>                 DefaultValue;                                      // 0x0030(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	struct FFrameTime                             LastKnownPosition;                                 // 0x0000(0x0008)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
