...
// Function UMG.UserWidget.PlayAnimationAtTime
// (Final, BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
...
class UUMGSequencePlayer* UUserWidget::PlayAnimationAtTime(class UWidgetAnimation* InAnimation, float StartAtTime, int32 NumLoopsToPlay, EUMGSequencePlayMode PlayMode, float PlaybackSpeed)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UserWidget", "PlayAnimationAtTime");

	Params::UserWidget_PlayAnimationAtTime Parms{};
...
class UUMGSequencePlayer* UUserWidget::PlayAnimationTo(class UWidgetAnimation* InAnimation, float StartAtTime, float EndAtTime, int32 NumLoopsToPlay, EUMGSequencePlayMode PlayMode, float PlaybackSpeed)
{
	static class UFunction* Func = nullptr;
